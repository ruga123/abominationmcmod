...
package net.mcreator.abominationmc.block;
...
import net.mcreator.abominationmc.procedures.DnaExtractorBlockAddedProcedure;
import net.mcreator.abominationmc.gui.DnaExtractorGuiGui;
...
public class DnaExtractorBlock extends AbominationmcModElements.ModElement {
	@ObjectHolder("abominationmc:dna_extractor")
	public static final Block block = null;
	@ObjectHolder("abominationmc:dna_extractor")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DnaExtractorBlock(AbominationmcModElements instance) {
		super(instance, 4);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(5f, 7f).setLightLevel(s -> 0).harvestLevel(3)
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				DnaExtractorBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
